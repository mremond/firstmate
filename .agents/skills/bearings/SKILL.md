...
- The four rendered buckets are mutually exclusive per item: needs-your-action is Captain's Call, a Done delivery selected by `bin/fm-landed-lib.sh` is Recently Landed, self-progressing is Underway, and not-yet-started work or an action-free fleet-integrity warning is Charted Next.
