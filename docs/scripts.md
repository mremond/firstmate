...
| `fm-checkout-write-guard.sh` | Refuse a test that creates, removes, or modifies any path under the repository checkout, with the pre-existing leaks pinned one script at a time |
